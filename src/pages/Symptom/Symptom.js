                    ...
                    <div className="mainWrapper">
                        <div className="wrapScreen">
                            <div className="screenHead">
                                ...
                                Select all symptoms that you are currently experiencing.</div>
                            </div>
                            <div className="workSpaceArea">
                            <div class="wrapBox">
                                ...
                                <div className="wrapBtn"><button
                                className="pure-material-button-contained">Submit Symptoms</button></div>
                            </div>
                            <div  ></div>
                        </div>
