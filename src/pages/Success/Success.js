        ...
        <div className="mainWrapperS">
          <div className="wrapScreenS">
            <div className="screenHeadS">
              ...
              <div claclassNamess="arrowS">
                <i className="fa fa-angle-left" aria-hidden="true"></i>
              </div>
              <div className="sucessImg001">
            ...
            <div className="workSpaceAreaS">
              <div className="sucess008S">
                <h1>Success!</h1>
                <p>
                  Thank you for uploading your results. Share your status and results with others to show that you care
                  and help stop the spread of COVID-19.
                </p>
              </div>
              <div className="wrapBtnS">
                <button className="whiteBGS">Submit Symptoms</button>
              </div>
            </div>
