              ...
              <div className="wrapInnerPart">
                <div className="container">
                  ...
                  <div className="boxWrap23">
                    <div className="work1">
                      <img alt="setting" src={setting} className="absoluteVN" />
                      <li>
                        <img
                          alt="test"
                      ...
                      <li>
                        ...
                        <div className="subHeads9832">
                          <img alt="minion" className="miniIon" src={sikIcon} />
                          Symptomatic
                        </div>
                      </li>
                      <li>
                        ...
                        <div className="subHeads9832">
                          <img alt="test" className="miniIon" src={cercleIon} />
                          Untested
                        </div>
                      </li>
                    </div>
                  ...
                  <div className="headingCenter">
                    <h4>Test Details</h4>
                    <img alt="test details" className="miniIon" src={shearIcon} />
                  </div>
                  <div className="boxWrap23">
                    <div className="row">
                    ...
                    <div className="tbsxyz-bar tbsxyz-black">
                      <div className="xyzButton">
                        <div className="xyzBtns">
                          <button className="tbsxyz-bar-item tbsxyz-button btnActive" onclick="openCity('Tests')">
                            Find Tests
                          </button>
                          <button className="tbsxyz-bar-item tbsxyz-button dvBtnz" onclick="openCity('Results')">
                            Test Results
                          </button>
                        </div>
                      </div>
                      <div className="arrow diffAreo">
                      ...
                      <div id="Tests" className="tbsxyz-container city">
                        ...
                        <p className="mt_zero11">
                          Open <span>9am - 5pm</span> <span>Walk-Up</span>
                        </p>
                        <p className="mt_zero12">
                          <span>Website</span> <span>Directions</span>{' '}
                          <span>
                  ...
                  <div className="btnXyx">
                    <div className="xrzt-bar xrzt-black">
                      <div className="rusltxyx">
                        <button className="xrzt-bar-item xrzt-button rtvActive" onclick="openCity('Overviews')">
                          Overviews
                        </button>
                      ...
                      <div style={{ marginTop: 20 + 'px' }} id="Overviews" className="xrzt-container city">
                        ...
                        <div style={{ marginTop: 20 + 'px' }} className="discripitonXyx">
                          ...
                          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur volutpat orci fusce ipsum.
                          Nibh augue amet, rhoncus nulla ultricies vulputate ornare. Amet dolor volutpat rhoncus, quis
                          sit. Aliquet scelerisque vulputate amet natoque. Pretium neque turpis arcu enim. Posuere
                          auctor velit arcu vestibulum. Tincidunt diam nisi convallis id a aliquam. Mattis euismod
                          tellus penatibus pellentesque parturient sodales nec mattis porta. Lacus amet, egestas turpis
                          sit id quisque pharetra, sit. Tristique sollicitudin sed ipsum sollicitudin. Urna ac enim quis
                          bibendum id orci.
                        </div>
