                        ...
                        <div className="WrapCondition">
                            <div className="wrapInnerPart">
                                <div className="container">
                                    ...
                                    <div className="conditionHeading text-center w-50per">
                                        <i className="fa fa-angle-left wBolder" aria-hidden="true"></i><span>Back</span>
                                        <div className="absoluteTY"><span>Edit Test Result</span></div>
                                    </div>
                                        ...
                                        <div className="row">
                                            <div className="col-lg-6">
                                                ...
                                                <div className="wrapBoxInp">
                                                    ...
                                                    <input type="date" placeholder="Williambsurg Drive-Thru Testing" />
                                                </div>
                                    ...
                                    <div className="wrapBtn"><button>Edit Test Result</button></div>
                                </div>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <div id="Results" className="tbsxyz-container city" style={{display:'none'}} >
                                                <div className="wrkWrap">
                                                    <div className="resultDiv">
                                                        ...
                                                        <div>Results: <span className="redClr"></span>Positive</div>
                                                    </div>
