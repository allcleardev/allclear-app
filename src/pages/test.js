          ...
          <div style={{ paddingTop: '15px' }}>
            ...
            <Button className="btn-gradient white">
              <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                  ...
                  4.24125 4.41008 4.50433C4.04536 4.98843 3.83536 5.10783 3.83536 5.70226C3.83536 6.29669 5.54246
                  7.98549 5.95065 8.40159C6.35573 8.81453 8.0567 10.2656 8.58378 10.3432C9.11456 10.4214 9.82513
                  9.87452
                   9.9762 9.73585C10.7447 9.16165 11.1786 9.59698 11.5326 9.78621C11.8866 9.97543 13.486 10.9453
                   13.9817
                    11.2723C14.4482 11.5992 14.419 12.1045 14.419 12.1045C14.419 12.1045 13.4569 13.5906 13.3403
                    13.7689C13.1945 13.9769 12.8446 14.1553 12.0574 14.1553C11.2702 14.1553 10.4291 14.0154 8.43013
                    12.9455C6.79453 12.0702 5.23535 10.6994 4.41898 9.89692C3.57345 9.09443 2.14112 7.49301 1.18695
                    5.80956Z`}
                  fill="white"
                />
              </svg>
            ...
            <Button className="btn-gradient white">
              <svg width="12" height="16" viewBox="0 0 12 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                  d={`M0.859863 8.15513V13.298C0.859863 13.639 0.995322 13.966 1.23644 14.2071C1.47756 14.4482
                   1.80458 14.5837 2.14558 14.5837H9.85986C10.2009 14.5837 10.5279 14.4482 10.769 14.2071C11.0101
